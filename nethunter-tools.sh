...
header() {
    ...
    printf "${RED}"
    printf "+------------------------------------------------------------------------+\n"
    printf "|  K  K   AA   L     IIII      N  N   H  H                              |\n"
    printf "|  K K   A  A  L       I       N N    H  H                              |\n"
    printf "|  KK    AAAA  L       I       N N    HHHH                              |\n"
    printf "|  K K   A  A  L       I       N  N   H  H                              |\n"
    printf "|  K  K  A  A  LLLL  IIII      N  N   H  H                              |\n"
    printf "|                                                                        |\n"
    printf "${GREEN}|               Kali NetHunter Tools Installer                     |\n"
    printf "|               ARM64 Tool Installer v%-3s                               |\n" "$SCRIPT_VERSION"
